...
of a "stack" data structure. Stacks are setup using arrays and linked lists.
...
**stack-array.py** - the main (driver) routine to illustrate the singly linked list
